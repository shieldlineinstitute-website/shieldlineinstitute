  ...
  return (
    ...
    >
      ...
      <div className="mt-12 inline-flex flex-wrap gap-4">
        <ScrollToTopLink to="/contact" className="inline-flex items-center gap-2 bg-[#F59E0B] hover:bg-[#D68C0E] text-white px-8 py-4 rounded-xl font-semibold transition-colors">
